 <template>
  <div class="rating_page">
    <top-header header-title="我的优惠" go-back='true'></top-header>
...
export default {
  ...
  methods: {
    ...
    async initData() {
      if (this.userInfo) {
        const res = await getHongbaoNum(this.userInfo.user_id);
    ...
    .hongbao_list_li {
      ...
      .list_item {
        ...
        .list_item_left {
          ...
          flex: 1;
          span:nth-of-type(1) {
            @mixin fsc .75rem, #ff5340;
            font-weight: bold;
          }
          span:nth-of-type(2) {
            @mixin fsc 1.5rem, #ff5340;
          }
          span:nth-of-type(3),
          span:nth-of-type(4) {
            @mixin fsc 0.8rem, #ff5340;
            font-weight: bold;
          }
          p {
            @mixin fsc 0.4rem, #999;
          }
        }
        .list_item_right {
          flex: 2;
