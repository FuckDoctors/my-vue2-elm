 <template>
  <div class="rating_page">
    <top-header header-title="账户信息" go-back='true'></top-header>
    <section class="profile-info">
      ...
      <section class="info-router" @click="changePhone">
        <section class="headportrait headportraitwo headportraithree">
          <h2>
            <img src="../../../assets/images/bindphone.png" style="display:inline-block;margin-right:.4rem;" alt="">手机</h2>
          <div class="headportrait-div">
            <p>{{tel}}</p>
            <span class="headportrait-div-bottom">
              <svg fill="#d8d8d8">
...
import { signout, uploadAvatar as uploadAvatar2 } from '@/service/getData';
  ...
  methods: {
    ...
    async uploadAvatar() {
      ...
      if (this.userInfo) {
        ...
        try {
          const res = await uploadAvatar2(this.userInfo.user_id, data);
