<template>
  <div class="profile_page">
    <top-header go-back='true' :header-title="profiletitle"></top-header>
    <section>
  ...
  .profile-link {
    ...
    .user-info {
      ...
      p {
        ...
        .icon-mobile-number {
          display: inline-block;
          @mixin fsc .57333rem, $fc;
        }
      }
    }
    .arrow {
      @mixin wh .46667rem, .98rem;
      display: inline-block;
      svg {
        @mixin wh 100%, 100%;
      }
