<template>
  <div class="paddingTop search_page">
    <top-header header-title="搜索" goBack="true"></top-header>
...
export default {
  ...
  methods: {
    ...
    async searchTarget(historyValue) {
      ...
      this.emptyResult = !this.restaurantList.data.length;
      /**
